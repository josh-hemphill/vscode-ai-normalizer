...
describe("mergeChatLanguageModelsProviders", () => {
  ...
  it("replaces only matching vendor and provider name", () => {
    ...
    const ours = merged.find((p) => p.name === "AI Normalizer");
